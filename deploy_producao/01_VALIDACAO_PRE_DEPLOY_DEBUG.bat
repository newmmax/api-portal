@echo off
REM ================================================
REM PASSO 1: VALIDAÇÃO PRÉ-DEPLOY (COM PAUSE)
REM ================================================
color 0E
cls
...
if not exist "fc-data-api.exe" (
    ...
    echo.
    echo Certifique-se de que voce esta executando este script
    echo da mesma pasta onde esta o fc-data-api.exe
    echo.
    echo Esta pasta deve conter:
    echo   - fc-data-api.exe
    echo   - .env
    echo   - Todos os scripts .bat
    echo.
    pause
    exit /b 1
)
